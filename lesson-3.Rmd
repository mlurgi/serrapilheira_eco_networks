...
An Island Biogeography model for food webs:
...
for(e in extinction){
  for(j in 1:replicates){
    ...
    y <- getURL(paste0("https://github.com/mlurgi/network-area/tree/master/networks/network-",j,'?raw=true'))
    load(url(paste0("https://github.com/mlurgi/network-area/tree/master/networks/network-",j)))
    S <- food_web$S
    presences <- array(0, S)
