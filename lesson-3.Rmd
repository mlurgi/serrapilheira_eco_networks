...
```{r, trophic-biogeography, fig.align='center', message=FALSE, warning=FALSE, out.width="60%", eval=FALSE}
source('funcs.r')
...
```{r, metacom-model, warning=FALSE, message=FALSE, out.width="60%", fig.align='center', eval=FALSE}
